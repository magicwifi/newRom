...
#define TABLE_WIFIDOG_LOGSERVERS "$ID$_LOGServers"
...
/** @brief Initializes the portalservers table */
void iptables_fw_set_portalservers(void);

/** @brief Clears the portalservers table */
void iptables_fw_clear_portalservers(void);

/** @brief Initializes the platservers table */
void iptables_fw_set_platservers(void);
